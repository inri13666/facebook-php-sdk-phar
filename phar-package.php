...
require_once implode(DS,array(dirname(__FILE__) , 'src')) . DS . 'Facebook/FacebookRequest.php';

if (!defined('__PHAR__VERSION__')) {
    define('__PHAR__VERSION__', \Facebook\FacebookRequest::VERSION);
}
...
$archive->buildFromDirectory('src');
